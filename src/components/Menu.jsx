                ...
                <div className="banner grid lg:grid-cols-2">
                    ...
                    <div className="flex justify-center text-center items-center bg-gradient-to-t lg:bg-gradient-to-l from-transparent to-zinc-900">
                        <div className="Download">
                            ...
                            <button className="border px-10 md:px-20 py-3 md:py-5 rounded-2xl md:rounded-2xl text-white lg:bg-gradient-to-r from-yellow-300 to-red-600 outline outline-black outline-1 border-black">
                                Download
                            </button>
                        </div>
                    </div>
